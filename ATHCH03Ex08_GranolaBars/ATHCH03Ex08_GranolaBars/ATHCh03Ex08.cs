...
namespace ATHCH03Ex08_GranolaBars
{
    class ATHCh03Ex08
    {
        ...
        static void Main()
        {
            ...
            //RETRIEVE NUMBER OF CASES SOLD 
            numOfCasesSold = NumberOfCases();

            //RETRIEVE PRICE OF PER BAR
            salePricePerBar = PricePerBar();

            //RETRIEVE NUMBER OF TOTAL BARS SOLD 
            numOfBarsSold = TotalNumberOfBars(numOfCasesSold);

            //RETRIEVE TOTAL PROFIT OF SALES 
            totalProfit = SalesProfit(numOfBarsSold, salePricePerBar);

            //RETRIEVE TOTAL PERCENTAGE GIVEN TO STUDENT GOV
        ...
        static double PricePerBar()
        {
            ...
            WriteLine("How much is each bar: ");
            inputValue = ReadLine();
