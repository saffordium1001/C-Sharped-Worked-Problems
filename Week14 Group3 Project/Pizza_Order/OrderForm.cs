 ...
 * Date: 04/13/2022
 * 
 * Purpose: Windows desktop form application to order pizza!
 * 
 * Class: CITP 180 (Spring '22 - CRN: 80660)
 * Assignment: Chapter #9, Programming Exercise #9 (Week 12 Group Project) 
*****************************************************************************************************************************************/
...
namespace Pizza_Order
{
    public partial class PizzaOrderForm : Form
    {
        ...
        public static double TaxRate = 0.06; // Tax percent 6 for State of Michigan%
